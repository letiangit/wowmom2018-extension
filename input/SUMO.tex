...
\textcolor{red}{The training stops once the cross-validation score remains stable (2 digits of precision) for $10$ successive iterations (i.e., 100 sample data points), or the number of training data points exceeds $2500$.}
